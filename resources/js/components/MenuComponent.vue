                    ...
                    <swiper-slide>
                        <div class="mobile-sort">
                            <button class="sort-btn mb-btn-common" @click="showSortModal"
                                    :class="{ 'bg-dark-custom' : checkPropertyExists('relevance') }">{{
                                    mobileSortTitle
                                }}
                    ...
                    <swiper-slide v-if="genetics.length > 0">
                        <div class="mobile-genetics">
                            <button class="genetic-btn mb-btn-common" @click="showGeneticModal"
                                    :class="{ 'bg-dark-custom' : checkPropertyExists('genetic') }">{{
                                    mobileGeneticTitle
                                }}
                                <svg class="mb-btn-common-svg" width="10px" height="10px" viewBox="0 0 451.847 451.847"
                                     style="transform:rotate(0deg)">
                            ...
                            <template v-else>
                                <template v-if="isFeatured && featuredProducts.length > 0">
                                    <carousel :items="3" :dots="false" :nav="false"
                                        ...
                                        <div v-for="featured in featuredProducts" :key="featured.id">
                                            <FeaturedProducts
                                                :featured="featured"
                                                :islogin="islogin"
                                                :retailerid="id"
...
export default {
    ...
    watch: {
        ...
        brandVerified: {
            handler(query) {
                if (query == true) {
                    console.log(this.brandVerified)
                } else {
                }
            }
        }
