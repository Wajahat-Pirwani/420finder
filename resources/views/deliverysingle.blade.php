...
@section('meta')
    ...
    {{$delivery->seo}}
    <link rel="canonical" href="https://www.420finder.net/public/deliveries/{{$delivery->slug}}/{{$delivery->id}}"/>
    <link rel="alternate" href="https://www.420finder.net/public/deliveries/{{$delivery->slug}}/{{$delivery->id}}" hreflang="en-ca"/>
    <link rel="alternate" href="https://www.420finder.net/public/deliveries/{{$delivery->slug}}/{{$delivery->id}}" hreflang="en-us"/>
    <link rel="alternate" href="https://www.420finder.net/public/deliveries/{{$delivery->slug}}/{{$delivery->id}}" hreflang="en-gb"/>
    <script type="application/ld+json">
        {
          ...
          "offers": {
            "@type": "Offer",
            "url": "https://www.420finder.net/public/deliveries/{{$delivery->slug}}/{{$delivery->id}}",
            "priceCurrency": "USD",
            "price": ""
          }
        }
        ...
        <div class="container">
            <div class="row topDeliveryRow retailer-single-info">
                ...
                <div class="col-sm-8 col-md-9 col-12">
                    ...
                    <?php
                    use App\Models\DeliveryProducts;$reviews = App\Models\RetailerReview::where('retailer_id', $delivery->id)->whereNull('product_id')->get();
                    ?>
                    ...
                    <div class="row detailedBox">
                        <div class="col-md-3 col-6">
                            <ul class="list-unstyled">
                                <li class="pb-2" style="font-weight: bold;"><i class="fas fa-car"></i> Delivery Service
                                </li>
                            ...
                            <ul class="list-unstyled">
                                <li class="pb-2"><i class="fas fa-clock"></i>
                                    @if($delivery->checkOpenStatus() == "CLOSED")
                                        <span
                                            style='color: red; font-weight: bold'>{{$delivery->checkOpenStatus()}} </span>
                                    @else
                                        <span
                        ...
                        <div class="col-md-12 d-flex">
                            ...
                            <a href="mailto:{{ $delivery->email }}"
                               class="btn btn-outline-dark px-4 ctaButtons ctaButtonSecond" target="_blank">
                                <i class="fas fa-envelope"></i> Email the retailer
                            </a>
                            <div class="favBrand favoriteButton retailer-single-fvt-btn">
                                @if (Session::has('customer_id') == false)
                                    <a href="{{ route('signin') }}"><i class="far fa-heart pe-4 shadow ms-3"></i></a>
                                @else
                                    ...
                                    ?>
                                    @if($fav)
                                        <a rel="{{ $delivery->id }}" data="Delivery" id="deletefavourite"
                                           class="unfavdelivery fav-style cursor-pointer">
                                            <i class="fa fa-heart pe-4 shadow ms-3"></i>
                                        </a>
                                        <a rel="{{ $delivery->id }}" data="Delivery" id="addfavourites"
            ...
            <div class="row mt-5">
                <div class="col-md-12">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active c-tabs" id="vue-menu-tab" data-bs-toggle="tab"
                                    data-bs-target="#vue-menu" type="button" role="tab" aria-controls="menu"
                                    aria-selected="true">Menu
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link c-tabs" id="details-tab-new" data-bs-toggle="tab"
                                    data-bs-target="#details-new" type="button" role="tab" aria-controls="details"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link deal-tab-btn c-tabs" id="deals-tab" data-bs-toggle="tab"
                                ...
                                <?php
                                $date = DB::table('subscription_details')->orderBy('id', 'DESC')->where('retailer_id', '=', $business->id)->first();
                    ...
                    <div class="tab-content" id="myTabContent">
                        {{-- VUE MENU --}}
                        <div class="tab-pane fade show active" id="vue-menu" role="tabpanel"
                             aria-labelledby="vue-menu-tab">
                            <?php
                            $products = DeliveryProducts::where('delivery_id', $delivery->id)->get();
                            $isLogin = false;
                            ...
                            @if (count($products) > 0 && ($currentDate >= $startDate) && ($currentDate <= $endDate))
                                <menu-component id="{{ $delivery->id }}"
                                                islogin="<?php echo $isLogin; ?>"></menu-component>
                            @else
                                <div style="margin-top: 0.9rem">
                                    <div class="refer-claim-wrap">
                                        <a target="_blank"
                                           href="mailto:support@420finder.net" class="d-block">
                                            <div class="refer-img">
                                                <img
                                    ...
                                    <div class="right-content-wrap">
                                        ...
                                        <div class="right-content-extra">
                                            ...
                                            <div class="location-name">
                                                ...
                                                <?php $state = \Illuminate\Support\Facades\DB::table('states')->where('id', '=', $delivery->state_province)->first(); ?>
                                                <p>{{ $delivery->address_line_1 }} {{ $delivery->city }}
                                                    , {{ $state->name ?? $delivery->state_province}}</p>
                                            </div>
                                            {{-- DELIVERY PHONE --}}
                                                ...
                                                <div class="time-content">
                                                    ...
                                                    <div class="week-content-wrap">
                                                        <div class="week-content">
                                                            ...
                                                            <div class="week-time">
                                                                <span>
                                                                    @if($business->monday_open == null)
                                                                        Closed
                                                                    @else
                                                                        {{ date("h:i A", strtotime($business->monday_open)) }}
                                                                    @endif
                                                                    -
                                                                    @if($business->monday_close == null)
                                                                        Closed
                                                                    @else
                                                                        {{ date("h:i A", strtotime($business->monday_close)) }}
                                                                    @endif
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="week-content">
                                                            ...
                                                            <div class="week-time">
                                                                <span>
                                                                    @if($business->tuesday_open == null)
                                                                        Closed
                                                                    @else
                                                                        {{ date("h:i A", strtotime($business->tuesday_open)) }}
                                                                    @endif
                                                                    -
                                                                    @if($business->tuesday_close == null)
                                                                        Closed
                                                                    @else
                                                                        {{ date("h:i A", strtotime($business->tuesday_close)) }}
                                                                    @endif
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="week-content">
                                                            ...
                                                            <div class="week-time">
                                                                <span>
                                                                    @if($business->wednesday_open == null)
                                                                        Closed
                                                                    @else
                                                                        {{ date("h:i A", strtotime($business->wednesday_open)) }}
                                                                    @endif
                                                                    -
                                                                    @if($business->wednesday_close == null)
                                                                        Closed
                                                                    @else
                                                                        {{ date("h:i A", strtotime($business->wednesday_close)) }}
                                                                    @endif
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="week-content">
                                                            ...
                                                            <div class="week-time">
                                                                <span>
                                                                    @if($business->thursday_open == null)
                                                                        Closed
                                                                    @else
                                                                        {{ date("h:i A", strtotime($business->thursday_open)) }}
                                                                    @endif
                                                                    -
                                                                    @if($business->thursday_close == null)
                                                                        Closed
                                                                    @else
                                                                        {{ date("h:i A", strtotime($business->thursday_close)) }}
                                                                    @endif
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="week-content">
                                                            ...
                                                            <div class="week-time">
                                                                <span>
                                                                    @if($business->friday_open == null)
                                                                        Closed
                                                                    @else
                                                                        {{ date("h:i A", strtotime($business->friday_open)) }}
                                                                    @endif
                                                                    -
                                                                    @if($business->friday_close == null)
                                                                        Closed
                                                                    @else
                                                                        {{ date("h:i A", strtotime($business->friday_close)) }}
                                                                    @endif
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="week-content">
                                                            ...
                                                            <div class="week-time">
                                                                <span>
                                                                    @if($business->saturday_open == null)
                                                                        Closed
                                                                    @else
                                                                        {{ date("h:i A", strtotime($business->saturday_open)) }}
                                                                    @endif
                                                                    -
                                                                    @if($business->saturday_close == null)
                                                                        Closed
                                                                    @else
                                                                        {{ date("h:i A", strtotime($business->saturday_close)) }}
                                                                    @endif
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="week-content">
                                                            ...
                                                            <div class="week-time">
                                                                <span>
                                                                    @if($business->sunday_open == null)
                                                                        Closed
                                                                    @else
                                                                        {{ date("h:i A", strtotime($business->sunday_open)) }}
                                                                    @endif
                                                                    -
                                                                    @if($business->sunday_close == null)
                                                                        Closed
                                                                    @else
                                                                        {{ date("h:i A", strtotime($business->sunday_close)) }}
                                                                    @endif
                                                                </span>
                                                            </div>
                                                        </div>
                        ...
                        {{-- DEALS --}}
                        <?php
                        $date = DB::table('deals')->orderBy('id', 'DESC')->where('retailer_id', '=', $business->id)->first();
                        $currentDate = date('Y-m-d');
                        $currentDate = date('Y-m-d', strtotime($currentDate));
                        $startDate = date('Y-m-d', strtotime($date->starting_date ?? '12-2-2021'));
                        $endDate = date('Y-m-d', strtotime($date->ending_date ?? '12-2-2021'));
                        ...
                        <div class="tab-pane fade deals-tab" id="deals" role="tabpanel" aria-labelledby="deals-tab">
                            <div class="row" style="margin-top: 1.5rem">
                                @if ( ($currentDate >= $startDate) && ($currentDate <= $endDate))
                                    <deals-slider :deals="{{$deals}}" :business="{{$business}}"></deals-slider>
                                @else
                                    <div class="container">
                                ...
                                {{--                                                @endif--}}
                                {{--                                                <div class="post-img">--}}
                                {{--                                                    <img src="{{ json_decode($deal->picture)[0] }}" class="card-img-top"--}}
                                {{--                                                         alt="...">--}}
